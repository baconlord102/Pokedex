...
//     styleTag.innerHTML = `
//     .stat-wrap .progress-bar::-webkit-progress-bar {
//         background-color: rgba(${rgbaColor}, 0.5);
//         }
//     .stat-wrap .progress-bar::-webkit-progress-value {
...
//   const capitalPokemonName = captitalizeFirstLetter (name);
  
//   document.querySelector("title").textContent = capitalPokemonName;
//   const detailmainElement = document.querySelector(".detail-main");
//   detailmainElement.classList.add(name.toLowerCase());

//   document.querySelector(".name-wrap .name").textContent = capitalPokemonName;
...
function displayPokemonDetails(pokemon) {
  const { name, id, types, weight, height, abilities, stats } = pokemon;
  const capitalPokemonName = capitalizeFirstLetter(name);
  ...
  document.querySelector("p.weight").textContent = `${weight / 10}kg`;
  document.querySelector("p.height").textContent = `${height / 10}m`;
